...
if test -f ~/.pocket-home/.version; then
  ...
  then
    jq '(.pages[0] | .items) |= . + [{ "name": "ScummVM", "icon": "~/PocketInstaller/Icons/scummvm.png", "shell": "/home/chip/PocketInstaller/Launchers/scummvm.sh" }]' ~/.pocket-home/config.json > tmp.$$.json
