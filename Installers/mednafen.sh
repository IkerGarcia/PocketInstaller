...
if test -f ~/.pocket-home/.version; then
  ...
  then
    jq '(.pages[0] | .items) |= . + [{ "name": "Mednafen", "icon": "~/PocketInstaller/Icons/mednafen.png", "shell": "/home/chip/PocketInstaller/Launchers/mednafront.sh" }]' ~/.pocket-home/config.json > tmp.$$.json
