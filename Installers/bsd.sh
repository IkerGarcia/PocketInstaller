...
if test -f ~/.pocket-home/.version; then
  ...
  then
    jq '(.pages[0] | .items) |= . + [{ "name": "BSD Games", "icon": "/usr/local/bin/pocketinstaller/Icons/bsdgames.png", "shell": "/home/chip/PocketInstaller/Launchers/bsdgames.sh" }]' ~/.pocket-home/config.json > tmp.$$.json
